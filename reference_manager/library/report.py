...
from reference_manager.library.identity import ensure_unique_paper_ids
from reference_manager.library.paths import ensure_manager_dirs, report_path
from reference_manager.models.paper import Paper
...
def write_report_atomic(root: Path, rows: list[dict[str, Any]], operation: str, checkpoint: bool = True, allow_empty: bool = False, expected_ids: set[str] | None = None) -> None:
    ...
    from reference_manager.services.checkpoints import create_checkpoint
